...
public interface UserDAO extends JpaRepository<User, String> {
    ...
    // 개인정보 + 프로필사진 변경
    @Modifying(clearAutomatically = true)
    @Query(value = "UPDATE user SET user_email = :email, user_phone = :phone, user_pwd = :password, user_img = :photo WHERE user_id = :id", nativeQuery = true)
    void changeProfile(@Param("email") String email, @Param("phone") String phone, @Param("password") String password ,@Param("photo") String photo, @Param("id") String id);
